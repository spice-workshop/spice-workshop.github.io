import{c as n,a as r,j as e,C as p,F as h}from"./index-BVQuYBoD.js";import{T as l}from"./ScheduleData-DJR_ndtC.js";import{S as u}from"./SectionTitle-CY208LSP.js";import{B as f}from"./Button-CFHq9OYM.js";import{S as b}from"./SEO-DJot-vKt.js";import{S as g}from"./search-CuqIr1kC.js";const j=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],k=n("chevron-down",j);const v=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],w=n("chevron-up",v),E=()=>{const[i,c]=r.useState("Day 1"),[a,d]=r.useState(""),[m,x]=r.useState(null),o=(l[i]||[]).filter(t=>t.title.toLowerCase().includes(a.toLowerCase())||t.speaker.toLowerCase().includes(a.toLowerCase())||t.abstract.toLowerCase().includes(a.toLowerCase()));return e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 animate-fade-in",children:[e.jsx(b,{title:"Talks & Abstracts | SPiCE 2 Conference",description:"Browse accepted talks and abstracts for the SPiCE 2 conference. Search by speaker, title, or topic.",url:"https://spice-workshop.github.io/talks",children:e.jsx("script",{type:"application/ld+json",children:`
              {
